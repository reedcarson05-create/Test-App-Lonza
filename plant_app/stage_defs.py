...
GENERIC_STAGE_DEFS = {
    ...
    "concentration": {
        ...
        "headers": [
            ...
            header("product_tank", "Product Tank", "numeric"),
    ...
    "reconcentration": {
        ...
        "tables": [
            table("Timed Readings", "reconcentration", 72, [
                ...
                column("condenser_vac_pi_4402", "Condenser Vac PI 4402"),
                column("system_pressure", "System Pressure (in Hg)"),
                column("h2o2_ppm", "H2O2 (ppm)", "numeric"),
                column("gcv", "GCV", "numeric"),
            ]),
        ],
    },
    ...
    "h2o2_koh_decolorizing": {
        ...
        "tables": [
            table("Bulk H2O2 Additions", "koh_h2o2", 20, [
                ...
                column("totalizer", "Totalizer (gal)", "numeric"),
                column("net_add", "Net Add (gal)", "numeric"),
    ...
    "centrifuge": {
        ...
        "headers": [
            ...
            header("shot_setup", "Shot Set-up", "numeric"),
            header("operator_initials", "Operator Initials", "text"),
        ],
        "tables": [
    ...
    "anion_exchange": {
        ...
        "tables": [
            table("Exchange Log", "anion_exchange", 50, [
                ...
                column("input_h2o2", "Input H2O2 (ppm)", "numeric"),
    ...
    "carbon_treatment": {
        ...
        "tables": [
            table("Carbon Usage", "carbon_usage", 20, [
                ...
                column("weight", "WT (lb)"),
                column("name", "Name"),
                column("lot_number", "Lot Number", "numeric"),
